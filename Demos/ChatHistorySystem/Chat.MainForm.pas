...
type
  ...
  private
    procedure PrependSystemMessage();
  end;
...
begin
  ...
  Self.PrependSystemMessage();
end;

procedure TMainForm.PrependSystemMessage();
var
  ChatMessage: TChatMessage;
  ChatMessages: TArray<TChatMessage>;
begin
  ChatMessage.Role := cmrSystem;
  ChatMessage.Content := 'You are a fantastic magician who wants to amaze whoever listens to you.';
  ChatMessages := [ChatMessage] + FChatHistory.GetMessages();
  FChatHistory.SetMessages(ChatMessages);
end;
    ...
    try
      ...
      FRequest.Run(
        ...
        begin
          ...
          if FChatHistory.GetMessages()[0].Role <> cmrSystem then
            Self.PrependSystemMessage();
